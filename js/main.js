...
require(['jquery'], function ($) {
	...
	var bookMarkFn = function (ele, options) {
		this.$ele = $(ele);
		this.options = {
			data: [{ "name": "精选", "url": "choice()", "icon": "icon/discover.png" }, { "name": "B站主页", "url": "https://space.bilibili.com/427378120", "icon": "icon/bilibilibog.png" }, { "name": "晨曦贴吧", "url": "https://byokpg.smartapps.cn", "icon": "icon/tieba.png" }, { "name": "晨曦网", "url": "http://cfff.cf", "icon": "icon/ico.png" }, { "name": "热榜", "url": "https://tophub.today", "icon": "icon/tophub.png" }, { "name": "导航", "url": "http://cfff.cf/navs/", "icon": "icon/pp93.png" }],
		};
